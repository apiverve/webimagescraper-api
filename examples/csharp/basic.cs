...
{
    class WebsiteImagesScraperExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/webimagescraper";

        /// <summary>
        /// Make a POST request to the Website Images Scraper API
        /// </summary>
        static async Task<JsonDocument> CallWebsiteImagesScraperAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { url &#x3D; &quot;https://en.wikipedia.org/wiki/Solar_System&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Website Images Scraper API...\n");

            var result = await CallWebsiteImagesScraperAPI();
