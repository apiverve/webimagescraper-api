...
class webimagescraperWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/webimagescraper');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/webimagescraper';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"url":{"type":"string","required":true,"format":"url"},"maxlinks":{"type":"integer","required":false,"min":1,"max":100,"default":25}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/webimagescraper`);
        }
    }
...
module.exports = webimagescraperWrapper;
