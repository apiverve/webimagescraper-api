# Website Images Scraper Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:webimagescraper-api:1.1.12'
}
```
...
```java
import com.apiverve.webimagescraper.WebsiteImagesScraperAPIClient;
import com.apiverve.webimagescraper.APIResponse;
import com.apiverve.webimagescraper.APIException;

// Initialize the client
WebsiteImagesScraperAPIClient client = new WebsiteImagesScraperAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/webimagescraper](https://docs.apiverve.com/ref/webimagescraper)
...
- **Issues:** [GitHub Issues](https://github.com/apiverve/webimagescraper-api/issues)
