// Package webimagescraper provides a Go client for the Website Images Scraper API.
//
// For more information, visit: https://apiverve.com/marketplace/webimagescraper?utm_source=go&utm_medium=readme
package webimagescraper
...
// Request contains the parameters for the Website Images Scraper API.
//
// Parameters:
//   - url (required): string - The URL of the website you want to scrape images from [format: url]
//   - maxlinks: integer - The limit of image URLs returned from your query [min: 1, max: 100]
type Request struct {
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"maxlinks": {Type: "integer", Required: false, Min: float64Ptr(1), Max: float64Ptr(100)},
	}
...
// ResponseData contains the data returned by the Website Images Scraper API.
type ResponseData struct {
	ImageCount int `json:"imageCount"`
	Images []ImagesItem `json:"images"`
	MaxLinksReached bool `json:"maxLinksReached"`
	Url string `json:"url"`
}

// ImagesItem represents an item in the Images array.
