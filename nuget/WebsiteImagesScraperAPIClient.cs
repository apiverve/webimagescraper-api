...
namespace APIVerve.API.WebsiteImagesScraper
{
    ...
    /// <summary>
    /// Client for the WebsiteImagesScraper API
    /// </summary>
...
#endif
    {
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "maxlinks", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 100 } }
        };
        ...
        private void ValidateParams(WebsiteImagesScraperQueryOptions options)
        {
